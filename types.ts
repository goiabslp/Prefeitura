...
export type AppPermission =
  ...
  | 'parent_diarias_viajar' | 'parent_diarias_adiantamento' | 'parent_frotas' | 'parent_agendamento_veiculo'
  | 'parent_agendamento_veiculo_agendar' | 'parent_agendamento_veiculo_dia' | 'parent_agendamento_veiculo_meus'
  | 'parent_agendamento_veiculo_aprovacoes' | 'parent_agendamento_veiculo_dashboard'
  ...
  | 'parent_consultas' | 'parent_consultas_novo_agendamento' | 'parent_consultas_liberar_vagas' | 'parent_consultas_agendar'
  | 'parent_consultas_acompanhar' | 'parent_consultas_definir_agenda' | 'parent_consultas_dados'
  | 'parent_consultas_pacientes' | 'parent_consultas_gestor'
  | 'sub_consultas_novo_agendamento' | 'sub_consultas_liberar_vagas' | 'sub_consultas_agendar'
  | 'sub_consultas_acompanhar' | 'sub_consultas_definir_agenda' | 'sub_consultas_dados'
  | 'sub_consultas_pacientes' | 'sub_consultas_gestor'
  | 'parent_farmacia' | 'parent_farmacia_criar' | 'parent_farmacia_editar' | 'parent_farmacia_excluir'
  | 'parent_farmacia_aprovar' | 'parent_farmacia_consultar' | 'parent_farmacia_retirar' | 'parent_farmacia_estoque'
  | 'parent_farmacia_dashboard' | 'parent_farmacia_pacientes' | 'parent_farmacia_gestor'
  | 'sub_farmacia_consultar' | 'sub_farmacia_retirar' | 'sub_farmacia_estoque'
  | 'sub_farmacia_dashboard' | 'sub_farmacia_pacientes' | 'sub_farmacia_gestor'
...
export interface FarmaciaMovimentacao {
  id: string;
  medicamento_id?: string;
  tipo: 'Entrada' | 'Saída' | 'Ajuste';
  quantidade: number;
  medicamento_nome: string;
  medicamento_categoria: 'CBAF' | 'CESAF' | 'CEAF';
