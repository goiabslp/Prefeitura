...
const VIEW_TO_PATH: Record<string, string> = {
  ...
  'vehicle-scheduling:vs_consultar': '/AgendamentoVeiculos/Consultar',
  ...
  'calendario:novo:setor': '/Calendario/Novo/Setor',
  'calendario:novo:programacao': '/Calendario/Novo/Programacao',
  'calendario:novo:jornal': '/Calendario/Novo/Jornal',
  ...
  'consultas:agendar': '/Consultas/Agendar',
          ...
          <div className="flex-1 flex relative overflow-hidden">
            ...
            {currentView === 'vehicle-scheduling' && (
              <VehicleSchedulingScreen
                ...
                currentUserSectorId={currentUser?.sectorId}
                ...
                requestedView={(() => {
                  ...
                  if (activeBlock === 'vs_consultar') return 'consultar';
                  return 'menu';
                })()}
                onNavigate={(path) => {
                  ...
                  else if (path === '/AgendamentoVeiculos/Consultar') setActiveBlock('vs_consultar');
            ...
            {currentView === 'consultas' && (
              <ConsultasModule
                ...
                onNavigate={(view) => {
                  ...
                  } else if (view === 'consultas:agendar') {
                    setAppState(prev => ({ ...prev, view: 'agendar' }));
                    window.history.pushState({}, '', '/Consultas/Agendar');
